...
export function ProfilePage() {
  ...
  return <section className="community-page profile-v2">
    ...
    <div className="profile-links-grid">
      ...
      <Link className="panel profile-feature-link" to="/alerts"><span><Bell /></span><div><p className="eyebrow">QUEUE TARGETS</p><h3>In-app queue targets</h3><p>Save the wait you want and check WashRadar for the latest status.</p></div><ChevronRight /></Link>
    </div>
